...
omp: src/openmp_single/*.cpp  src/common/*.cpp
	${CXX} ${CXX_FLAGS} $^ -I src/openmp_single -I src/common -o $@

mpi: src/mpi/*.cpp  src/common/*.cpp
	${MPICXX} ${CXX_FLAGS} $^ -I src/mpi -I src/common -o $@

upload:
	scp -i ~/.ssh/id_rsa_hpc -r Makefile src *.cpp *.sh edu-cmc-skmodel25-627-08@polus.hpc.cs.msu.ru:~/project/
